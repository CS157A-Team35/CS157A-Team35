		  ...
		  //Additional Contact
		    Statement stmt4 = con.createStatement();
		    		    ...
		    		    if (rs4.next()==true){
			    		    ...
			    		    if (rs7.next()!=true){ //does not exist already
			    		    	Statement stmt5 = con.createStatement();
			    		    	...
			    		    	Statement stmt6= con.createStatement();
			    				   stmt6.executeUpdate("INSERT INTO search4houses.Listings_AdditionalContact (listing_id, addContact_id) VALUES ("+newGeneratedID+", "+contactID+");");
			    				    System.out.println(newGeneratedID+contactID);
